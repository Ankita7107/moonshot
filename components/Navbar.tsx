...
const servicesMenu = {
  tech: [
    { icon: Globe, label: "WebCore", desc: "Performance-first web apps", href: "/services#custom-web-solutions" },
    { icon: Settings, label: "Enterprise ERP", desc: "Streamlined business tools", href: "/services#enterprise-software" },
    { icon: Cloud, label: "CloudPulse", desc: "Automated infra scaling", href: "/services#cloud-devops" },
    { icon: Zap, label: "CognitiveAI", desc: "Intelligent automation", href: "/services#ai-machine-learning" },
    { icon: Shield, label: "CyberShield", desc: "Threat audits & protection", href: "/services#cybersecurity" },
    { icon: Smartphone, label: "SwiftMobile", desc: "Native & hybrid experiences", href: "/services#mobile-app-development" },
    { icon: Code2, label: "ConnectAPI", desc: "Secure data integrations", href: "/services#api-development-integration" },
    { icon: Layout, label: "StudioUX", desc: "User-centric design systems", href: "/services#ui-ux-design" },
    { icon: MessageSquare, label: "AutomateBOT", desc: "Intelligent conversational agents", href: "/services#ai-chatbots-automation" },
    { icon: RefreshCcw, label: "UnifiedCRM", desc: "Custom business management", href: "/services#erp-crm-systems" },
    { icon: Shield, label: "QAguard", desc: "Automated QA & stability", href: "/services#software-testing-qa" },
  ],
  finance: [
    { icon: Banknote, label: "Ledger", href: "/services#ledger", color: "text-sky-500" },
    { icon: ShieldCheck, label: "Invoice", href: "/services#invoice", color: "text-green-500" },
    { icon: TrendingUp, label: "Expense", href: "/services#expense", color: "text-yellow-500" },
    { icon: IndianRupee, label: "StockControl", href: "/services#stock", color: "text-violet-500" },
    { icon: Home, label: "Billing", href: "/services#billing", color: "text-orange-500" },
    { icon: BarChart2, label: "Payroll", href: "/services#payroll", color: "text-fuchsia-500" },
  ],
};
