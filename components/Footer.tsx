  ...
  return (
    <footer className="bg-white border-t border-slate-100 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              {["About Us", "Services", "Why Choose Us", "Contact"].map((item) => (
          ...
          {/* Expertise */}
          <div>
            <h4 className="font-semibold text-slate-800 mb-4">Expertise</h4>
            <ul className="space-y-2 text-sm text-slate-500">
        ...
        <div className="border-t border-slate-100 pt-6 flex flex-col md:flex-row items-center justify-between text-sm text-slate-400">
