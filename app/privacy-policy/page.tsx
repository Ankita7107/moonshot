      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 text-center overflow-hidden">
        ...
        >
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto">
            Ensuring your data is protected under GDPR, CCPA, and Australian
            Privacy laws.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-4 gap-8">
                ...
                <nav className="space-y-2">
                  {navItems.map((item) => (
                    <a
                      ...
                      className="block text-sm text-slate-600 hover:text-sky-600 py-1.5 transition-colors"
                    >
                      {item}
                    </a>
                  ))}
            ...
            <motion.div className="lg:col-span-3 space-y-12">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      ...
                      information. This policy details how we collect and
                      protect your data across our platforms.
                    </p>
                  </div>
                </div>
              </section>
                    ...
                    <div className="grid sm:grid-cols-2 gap-3 text-sm text-slate-600">
                      {[
                        ...
                        <div key={u} className="flex gap-2">
                          <CheckCircle className="w-4 h-4 text-sky-500" /> {u}
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mb-4">
                      ...
                      personal data and opt-out of marketing at any time.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section
                id="contact"
                className="bg-gradient-to-r from-sky-50 to-indigo-50 rounded-2xl shadow-sm border border-sky-100 p-8"
              >
                <div className="flex items-start gap-4">
